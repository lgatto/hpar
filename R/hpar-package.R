...
##'
##' Several flat files are distributed by the HPA project and
##' available within the package as data.frames, other datasets are
##' available through a search query on the HPA website.  The
##' description below is taken from the HPA site:
##'
...
##'   *Show/hide columns*.
##'
##' Use `hpar::allHparData()` to get a list of all datasets.
##'
...
##' @seealso
##'
##' - [getHpaDate()] for release information. Gene-specific
##'   information should be accessed using the [getHpa()] function.
##'
